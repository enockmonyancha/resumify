...
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
  ...
  const url = `https://Resumify.com/blog/${slug}`;
  const publishedTime = new Date(post.frontMatter.date).toISOString();
  
  return {
    title: post.frontMatter.title,
    description: post.frontMatter.description,
    keywords: ['resume builder', 'tech jobs', 'Nigeria tech', 'career advice', 'AI resume', 'job search'],
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                publisher: {
                  ...
                  logo: {
                    '@type': 'ImageObject',
                    url: 'https://Resumify.com/og.webp',
                  },
                  url: 'https://Resumify.com',
                },
                mainEntityOfPage: {
                  '@type': 'WebPage',
                  '@id': `https://Resumify.com/blog/${slug}`,
                },
          ...
          <div className="text-center">
            <div className="inline-block p-8 rounded-2xl bg-gradient-to-r from-teal-50 to-cyan-50 border border-teal-100">
              ...
              <p className="text-gray-600 mb-6 max-w-md mx-auto">
                Join thousands of professionals who have already transformed their careers with Resumify.
              </p>
