...
export const metadata: Metadata = {
  title: "Login | Resumify - AI-Powered Resume Builder",
  description: "Create tailored, ATS-optimized resumes powered by AI. Resumify helps you land your dream tech job with personalized resume optimization.",
  keywords: ["resume builder", "AI resume", "ATS optimization", "tech jobs", "career tools", "job application"],
  authors: [{ name: "Resumify" }],
  openGraph: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Resumify - AI Resume Builder",
      },
    ],
    locale: "en_US",
    type: "website",
