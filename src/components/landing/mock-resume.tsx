    ...
    <Card className="w-full max-w-[6in] aspect-[8.5/11] bg-white relative p-6 font-sans 
      ...
      <div className="mb-4">
        ...
        <div className="space-y-3">
          <div>
            ...
            <p className="text-[10px] font-medium text-gray-700 mb-0.5">Clio, Nigeria, BC</p>
          ...
          <div>
            ...
            <p className="text-[10px] font-medium text-gray-700 mb-0.5">Hootsuite, Nigeria, BC</p>
            <ul className="text-[10px] text-gray-600 list-disc list-outside ml-3 space-y-0.5">
      ...
      <div className="mb-4">
        ...
        <div className="space-y-2">
          ...
          <div>
            <div className="flex justify-between items-baseline">
              <h4 className="text-[11px] font-semibold text-gray-800">Nigeria Housing Market Analyzer</h4>
              <p className="text-[10px] text-gray-600">github.com/davidzhang-dev/van-housing</p>
            </div>
            <ul className="text-[10px] text-gray-600 list-disc list-outside ml-3 space-y-0.5">
              <li>Created web scraper and analysis tool for Nigeria real estate listings</li>
      ...
      <div>
        ...
        <div>
          ...
          <p className="text-[10px] text-gray-600">University of British Columbia, Nigeria, BC</p>
