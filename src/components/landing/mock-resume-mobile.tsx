    ...
    <Card className="w-full max-w-[6in] aspect-[8.5/11] bg-white relative p-4 font-sans 
      ...
      <div className="mb-3">
        ...
        <div className="space-y-2">
          <div>
            ...
            <p className="text-[8px] font-medium text-gray-700 mb-0.5">Clio, Nigeria, BC</p>
          ...
          <div>
            ...
            <p className="text-[8px] font-medium text-gray-700 mb-0.5">Hootsuite, Nigeria, BC</p>
            <ul className="text-[8px] text-gray-600 list-disc list-outside ml-2.5 space-y-0.5">
      ...
      <div>
        ...
        <div>
          ...
          <p className="text-[8px] text-gray-600">University of British Columbia, Nigeria, BC</p>
